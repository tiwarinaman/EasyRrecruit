...
urlpatterns = [
   ...
   path('candi_reg', views.candidateRegister, name='candidateRegister'),
   path('candi_login', views.candidateLogin, name='candidateLogin'),
   path('recu_reg', views.recruiterRegister, name='recruiterRegister'),
   path('recu_login', views.recruiterLogin, name='recruiterLogin'),
